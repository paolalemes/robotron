...
const robotronCores = ["Amarelo", "Branco", "Azul", "Preto", "Rosa"];
const robotron = document.querySelector("#robotron-img");
let cor = 0;

robotron.addEventListener("click", () => {
  if (cor >= robotronCores.length) {
    cor = 0;
  }
  robotron.src = `img/${robotronCores[cor]}.png`;
  cor++;
});
